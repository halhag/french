...
export function QuestionCard({
  ...
  // Get a full French translation for the incorrect English option
  const getFrenchHint = (englishOption: string): string => {
    const lower = englishOption.toLowerCase();

    // Extract key context from the original sentence
    const frenchLower = question.sentence.french.toLowerCase();
            ...
            <div className="mt-4 p-4 bg-gray-700 border border-orange-500 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex">
                  ...
                  <span className="text-orange-100">{question.sentence.french}</span>
                </div>
                <div className="flex">
                ...
                <div className="border-t border-gray-600 pt-2 mt-2">
                  ...
                  {question.sentence.incorrectOptions.map((option, index) => (
